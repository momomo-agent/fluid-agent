...
;(function (root, factory) {
  ...
  else { const m = factory(); root.Agentic = m.Agentic; root.agenticAi = m.ai }
  ...
  function load(name) {
    ...
    // Browser: check global scope for pre-loaded modules
    const globalMap = { 'agentic-core': typeof AgenticCore !== 'undefined' ? AgenticCore : null }
    if (globalMap[name]) { _cache[name] = globalMap[name]; return _cache[name] }
    try {
